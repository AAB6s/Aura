      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 text-sm text-muted-foreground max-w-md">
            L'intelligence artificielle au service de la protection, du soutien et de la
            dignité des femmes. Une plateforme calme, sûre et accessible.
          </p>
          <p className="mt-4 text-xs text-muted-foreground">
            En cas d'urgence immédiate, composez le <strong className="text-foreground">3919</strong> (France) — appel anonyme et gratuit.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            <li><Link to="/models" className="hover:text-foreground">Nos outils</Link></li>
            <li><Link to="/dashboard" className="hover:text-foreground">Dashboard</Link></li>
            <li><Link to="/resources" className="hover:text-foreground">Ressources</Link></li>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            ...
            <li><a href="#" className="hover:text-foreground">Accessibilité</a></li>
